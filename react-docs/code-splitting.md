...
### Bundling <a href="#bundling" id="bundling"></a>
...
### Code Splitting <a href="#code-splitting" id="code-splitting"></a>
...
### Route-based code splitting <a href="#route-based-code-splitting" id="route-based-code-splitting"></a>
