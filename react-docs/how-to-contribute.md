...
#### [Code of Conduct](https://github.com/facebook/react/blob/main/CODE\_OF\_CONDUCT.md) <a href="#code-of-conduct" id="code-of-conduct"></a>

Facebook has adopted the [Contributor Covenant](https://www.contributor-covenant.org) as its Code of Conduct, and we expect project participants to adhere to it. Please read [the full text](https://github.com/facebook/react/blob/main/CODE\_OF\_CONDUCT.md) so that you can understand what actions will and will not be tolerated.
