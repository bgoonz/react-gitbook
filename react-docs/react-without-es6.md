...
### Declaring Default Props <a href="#declaring-default-props" id="declaring-default-props"></a>
...
### Setting the Initial State <a href="#setting-the-initial-state" id="setting-the-initial-state"></a>
...
### Autobinding <a href="#autobinding" id="autobinding"></a>
...
### Mixins <a href="#mixins" id="mixins"></a>
...
Sometimes very different components may share some common functionality. These are sometimes called [cross-cutting concerns](https://en.wikipedia.org/wiki/Cross-cutting\_concern). `createReactClass` lets you use a legacy `mixins` system for that.
