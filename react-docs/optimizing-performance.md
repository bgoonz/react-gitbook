...
### Use the Production Build <a href="#use-the-production-build" id="use-the-production-build"></a>
...
#### Single-File Builds <a href="#single-file-builds" id="single-file-builds"></a>
...
#### Brunch <a href="#brunch" id="brunch"></a>
...
#### Rollup <a href="#rollup" id="rollup"></a>
...
> **Note:**
>
> If you're using Create React App, please follow [the instructions above](broken-reference).\
...
### Profiling Components with the DevTools Profiler <a href="#profiling-components-with-the-devtools-profiler" id="profiling-components-with-the-devtools-profiler"></a>
...
### Avoid Reconciliation <a href="#avoid-reconciliation" id="avoid-reconciliation"></a>
...
### shouldComponentUpdate In Action <a href="#shouldcomponentupdate-in-action" id="shouldcomponentupdate-in-action"></a>
...
### The Power Of Not Mutating Data <a href="#the-power-of-not-mutating-data" id="the-power-of-not-mutating-data"></a>
