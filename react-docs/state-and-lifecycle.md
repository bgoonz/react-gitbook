...
### Converting a Function to a Class <a href="#converting-a-function-to-a-class" id="converting-a-function-to-a-class"></a>
...
### Adding Local State to a Class <a href="#adding-local-state-to-a-class" id="adding-local-state-to-a-class"></a>
...
### Adding Lifecycle Methods to a Class <a href="#adding-lifecycle-methods-to-a-class" id="adding-lifecycle-methods-to-a-class"></a>
...
#### Do Not Modify State Directly <a href="#do-not-modify-state-directly" id="do-not-modify-state-directly"></a>
...
#### State Updates May Be Asynchronous <a href="#state-updates-may-be-asynchronous" id="state-updates-may-be-asynchronous"></a>
