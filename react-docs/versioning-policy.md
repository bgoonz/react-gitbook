...
#### Commitment to Stability <a href="#commitment-to-stability" id="commitment-to-stability"></a>
...
#### Gradual Upgrades via Warnings <a href="#gradual-upgrades-via-warnings" id="gradual-upgrades-via-warnings"></a>
...
#### What Counts as a Breaking Change? <a href="#what-counts-as-a-breaking-change" id="what-counts-as-a-breaking-change"></a>
...
#### If a Minor Release Includes No New Features, Why Isn't It a Patch? <a href="#minors-versus-patches" id="minors-versus-patches"></a>
