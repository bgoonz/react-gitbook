...
#### How do I pass an event handler (like onClick) to a component? <a href="#how-do-i-pass-an-event-handler-like-onclick-to-a-component" id="how-do-i-pass-an-event-handler-like-onclick-to-a-component"></a>
...
#### How do I bind a function to a component instance? <a href="#how-do-i-bind-a-function-to-a-component-instance" id="how-do-i-bind-a-function-to-a-component-instance"></a>
...
#### Is it OK to use arrow functions in render methods? <a href="#is-it-ok-to-use-arrow-functions-in-render-methods" id="is-it-ok-to-use-arrow-functions-in-render-methods"></a>

Generally speaking, yes, it is OK, and it is often the easiest way to pass parameters to callback functions.

If you do have performance issues, by all means, optimize!

#### Why is binding necessary at all? <a href="#why-is-binding-necessary-at-all" id="why-is-binding-necessary-at-all"></a>
...
#### Why is my function being called every time the component renders? <a href="#why-is-my-function-being-called-every-time-the-component-renders" id="why-is-my-function-being-called-every-time-the-component-renders"></a>
...
#### How do I pass a parameter to an event handler or callback? <a href="#how-do-i-pass-a-parameter-to-an-event-handler-or-callback" id="how-do-i-pass-a-parameter-to-an-event-handler-or-callback"></a>
...
#### How can I prevent a function from being called too quickly or too many times in a row? <a href="#how-can-i-prevent-a-function-from-being-called-too-quickly-or-too-many-times-in-a-row" id="how-can-i-prevent-a-function-from-being-called-too-quickly-or-too-many-times-in-a-row"></a>
...
See [this visualization](http://demo.nimius.net/debounce\_throttle/) for a comparison of `throttle` and `debounce` functions.
