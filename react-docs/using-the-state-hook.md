...
### Equivalent Class Example <a href="#equivalent-class-example" id="equivalent-class-example"></a>
...
### Hooks and Function Components <a href="#hooks-and-function-components" id="hooks-and-function-components"></a>
...
### What's a Hook? <a href="#whats-a-hook" id="whats-a-hook"></a>
...
### Declaring a State Variable <a href="#declaring-a-state-variable" id="declaring-a-state-variable"></a>
...
### Reading State <a href="#reading-state" id="reading-state"></a>
...
### Updating State <a href="#updating-state" id="updating-state"></a>
...
#### Tip: What Do Square Brackets Mean? <a href="#tip-what-do-square-brackets-mean" id="tip-what-do-square-brackets-mean"></a>
...
#### Tip: Using Multiple State Variables <a href="#tip-using-multiple-state-variables" id="tip-using-multiple-state-variables"></a>
