...
#### Element Variables <a href="#element-variables" id="element-variables"></a>
...
#### Inline If with Logical && Operator <a href="#inline-if-with-logical--operator" id="inline-if-with-logical--operator"></a>
...
#### Inline If-Else with Conditional Operator <a href="#inline-if-else-with-conditional-operator" id="inline-if-else-with-conditional-operator"></a>
...
#### Preventing Component from Rendering <a href="#preventing-component-from-rendering" id="preventing-component-from-rendering"></a>
